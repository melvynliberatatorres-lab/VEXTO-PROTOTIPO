...
<body>
    ...
    <div class="sidebar">
        <div>
            ...
            <a href="dashboard.php" class="nav-item"><i class="fas fa-home"></i> Inicio</a>
            <a href="properties.php" class="nav-item active"><i class="fas fa-search"></i> Explorar</a>
            <a href="publish.php" class="nav-item"><i class="fas fa-plus-circle"></i> Publicar</a>
            <a href="settings.php" class="nav-item"><i class="fas fa-user"></i> Perfil</a>
        </div>
    ...
    <div class="main-content">
        <div class="header-sticky">
            <h2>Explorar</h2>
            <form action="properties.php" method="GET" class="search-bar">
        ...
        <div class="grid">
            ...
            <?php else: ?>
                <?php foreach ($properties as $prop): ?>
                    <?php
                        $imageSrc = 'https://via.placeholder.com/600x400?text=VEXTO';
                        if (!empty($prop['imagen_url']) && file_exists($prop['imagen_url'])) {
                            $imageSrc = $prop['imagen_url'];
                        } elseif (!empty($prop['imagen'])) {
