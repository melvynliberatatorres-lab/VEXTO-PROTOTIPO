...
<div class="main-container" style="max-width: 1200px; margin: 40px auto; flex-direction: column;">
    <div style="width: 100%;">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 30px;">
            ...
            <a href="publish_new.php" class="btn btn-primary" style="padding: 12px 25px;">+ Nueva Publicación</a>
        </div>
        ...
        <?php if (empty($properties)): ?>
            <div style="text-align: center; padding: 60px 20px; background: var(--card-bg); border: 1px solid var(--border-color); border-radius: 12px;">
                ...
                <a href="publish_new.php" class="btn btn-primary">Crear Primera Publicación</a>
            </div>
        <?php else: ?>
                ...
                <?php foreach ($properties as $prop): ?>
                    <div class="property-card" style="position: relative; overflow: visible;">
                        <div class="property-img-container" style="position: relative;">
                            <?php if (!empty($prop['imagen_url']) && file_exists($prop['imagen_url'])): ?>
                                <img src="<?php echo htmlspecialchars($prop['imagen_url']); ?>" alt="<?php echo htmlspecialchars($prop['titulo']); ?>" class="property-img" style="width: 100%; height: 220px; object-fit: cover;">
                            <?php elseif ($prop['imagen']): ?>
                                <img src="data:<?php echo htmlspecialchars($prop['imagen_tipo']); ?>;base64,<?php echo base64_encode($prop['imagen']); ?>" alt="<?php echo htmlspecialchars($prop['titulo']); ?>" class="property-img" style="width: 100%; height: 220px; object-fit: cover;">
                            <?php else: ?>
                                <div style="width: 100%; height: 220px; background: var(--secondary-bg); display: flex; align-items: center; justify-content: center; color: #999;">
                        ...
                        <div class="property-info">
                            ...
                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px;">
                                <a href="publish_new.php?edit=<?php echo $prop['id']; ?>" class="btn btn-primary" style="text-align: center; padding: 10px; font-size: 0.9rem;">
